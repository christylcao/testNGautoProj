...
public class AddCategoryPage {
	...
	@FindBy(how = How.XPATH, using = "//option[@value = '2']") WebElement MARCH;
	@FindBy(how = How.XPATH, using = "//option[@value = '2']") WebElement APRIL;
	@FindBy(how = How.XPATH, using = "//option[@value = '2']") WebElement MAY;
	@FindBy(how = How.XPATH, using = "//option[@value = '2']") WebElement JUNE;
	@FindBy(how = How.XPATH, using = "//option[@value = '2']") WebElement JULY;
	@FindBy(how = How.XPATH, using = "//option[@value = '2']") WebElement AUGUST;
	@FindBy(how = How.XPATH, using = "//option[@value = '2']") WebElement SEPTEMBER;
	@FindBy(how = How.XPATH, using = "//option[@value = '2']") WebElement OCTOBER;
	@FindBy(how = How.XPATH, using = "//option[@value = '2']") WebElement NOVEMBER;
	@FindBy(how = How.XPATH, using = "//option[@value = '2']") WebElement DECEMBER;
